...
<body class="body-personalizado">
    <nav class="navbar navbar-expand-lg navbar-dark navbar-absolute fixed-top bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Academia de Canto</a>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-8 offset-md-2 text-center">
                <h1>Bienvenido a Yeka Coach Academy</h1>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 offset-md-3 text-center">
                <h2>Contacto</h2>
                <p>¿Tienes alguna pregunta o consulta? No dudes en ponerte en contacto con nosotros.</p>
